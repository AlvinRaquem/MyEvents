...
<div class="col-xs-12">
  ...
  <div class="row">
           ...
           <div class="col-md-6 pull-right">
                 ...
                 <!-- search form -->
                   <div class="col-md-6 pull-right">
      {!! Form::open(['method'=>'GET','url'=>'Pending/Events/Search']) !!}
            ...
            <!-- /.box-header -->          <div class="box-body" style="overflow-x:auto;">
              <table id="table" class="table table-bordered table-striped">
                ...
                <tr class="item{{$event->id}}">
                  <td align="center">
             {{  Html::linkroute('admin.events.show','View',array($event->id),['class'=>'btn btn-success glyphicon glyphicon-eye-open']) }}</td>
